...
public class PlayerLog
{
    ...
    private static final Map<String, PlayerLog> LOGS = new HashMap<>();
     ...
     */
    public static PlayerLog getLog(String name) {
        synchronized (LOGS) {
            if(!LOGS.containsKey(name.toLowerCase())) {
                LOGS.put(name.toLowerCase(), new PlayerLog(name));
            }
        }
    ...
    /**
     * Removes all File-logs created via {@link #addFileLog(PlayerLog.Level, java.io.File)} with given Level.
    ...
    /**
     * Removes all File-logs created via {@link #addFileLog(PlayerLog.Level, java.io.File)} with given File.
     * To remove the sout and serr logs, call {@link #addFileLogs(java.io.File, java.io.File)} with null args.
     *
     * @param file
...
//                JDAImpl.LOG.log(e);
     ...
     * If this level is set to null, the global Log-level ({@link PlayerLog#LEVEL}) will be used
     *
    ...
    {
        return level == null ? PlayerLog.LEVEL : level;
    }
    ...
    public void log(Level level, Object msg) {
        ...
        if(level == Level.OFF || level.getPriority() < ((this.level == null) ? PlayerLog.LEVEL.getPriority() : this.level.getPriority())) {
    ...
    /**
     * This interface has to be able to register (via {@link PlayerLog#addListener(PlayerLog.LogListener)}) and listen to log-messages.
     */
    public interface LogListener
    {
         ...
         */
        void onLog(PlayerLog log, Level logLevel, Object message);
         ...
         */
        void onError(PlayerLog log, Throwable err);
    }
     ...
     *  <p>
     *  This was taken from the ExceptionUtils class in the
     *  org.apache.commons.lang3.exception package.
     */
